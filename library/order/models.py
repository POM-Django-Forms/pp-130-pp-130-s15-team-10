...
class Order(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['user', 'book'], name='unique_user_book_order')
        ]
    ...
    def calculate_penalty(self):
        if self.end_at and self.end_at > self.plated_end_at:
            days_late = (self.end_at - self.plated_end_at).days
            return round(days_late * 0.05, 2)
        return 0.00
